if (window.__TAURI_INTERNALS__) {
  import('./desktop.js').catch(error => {
    $('#watchState').textContent='DESKTOP FOLDER WATCH COULD NOT LOAD';
    console.error('Tabbycat desktop bridge failed', error);
  });
} else {
